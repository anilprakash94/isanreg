...
def model_run(args, train_peaks, val_peaks):
    ...
    dir_path = weights_filepath(args.model_dir+"/"+args.tf_name)
    ...
    log_name = dir_path + "/" + args.tf_name + "_train.log"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='ISANREG Training')
    ...
    train_file = args.data_dir + "/" + args.tf_name + "_train.txt"
    val_file = args.data_dir + "/" + args.tf_name + "_val.txt"
    print("Extracting training data from file...")
    train_peaks = extract_peaks(train_file)
    
    print("Extracting validation data from file...")
    val_peaks = extract_peaks(val_file)
